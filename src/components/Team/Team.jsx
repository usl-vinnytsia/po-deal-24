    ...
    <section id="team" className="team">
      <div className=' team__container'>
        <aside className='team-left'>
          ...
          гарні слова, чи справжні імена?<br></br>
          Обираємо друге: Аліна Вовковинська, Ілля Несен, Анатолій Хрустовський, Марія Маєвська, Павло Костишин, Ангеліна Масалаб, Іван Сотник, Влад Копиченський, Вікторія Кравець, Дар'я Дусанюк, Назарій Ковтун та інші
            <br></br>
            <br></br>
